...
import { getInvalidRobloxUserEmbed, getRobloxUserIsNotMemberEmbed, getVerificationChecksFailedEmbed, getUnexpectedErrorEmbed, getSuccessfulUnGroupBanEmbed } from '../../handlers/locale';
    ...
    constructor() {
        super({
            ...
            args: [
                ...
                {
                    trigger: "reason",
                    description: "The reason for why you wish to unban from the group",
                    autocomplete: true,
                    required: false,
                    type: "String"
                }
